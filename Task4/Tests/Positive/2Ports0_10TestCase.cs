...
namespace Task3.Tests.Positive
{
    ...
    /// <summary>
    /// Test case: 2 ports, speed: 0, 10.
    /// Total speed: 10.
    /// </summary>
    public class _2Ports0_10TestCase : NcPositiveTestFlow
    {
        ...
        /// Test case #1.
        /// </summary>
        public const string testName = "_2Ports0_10Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="_2Ports0_10TestCase" /> class.
        /// </summary>
        /// <param name="testName">
        /// Test name.
        /// </param>
        ...
        /// Test description.
        /// </param>
        public _2Ports0_10TestCase(string testName, string testDescription) : base(testName, testDescription)
        {
        }
